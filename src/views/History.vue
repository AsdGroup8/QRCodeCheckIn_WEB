    ...
    >
      ...
      <template v-slot:default="props">
        <v-row>
          ...
          >
            <v-card>
              <v-card-title class="subheading font-weight-bold">{{ item.movietitle }}</v-card-title>
              ...
              <v-card-actions>
                <v-btn text color="error" @click="deleteReservation(reservation_index)">Delete</v-btn>
              </v-card-actions>
            </v-card>
          </v-col>
        </v-row>
...
export default {
  data() {
    return {
      ...
      keys: ["ReservationID", "ReservationTime", "StartTime"],
      items: [],
    };
  },
  computed: {
